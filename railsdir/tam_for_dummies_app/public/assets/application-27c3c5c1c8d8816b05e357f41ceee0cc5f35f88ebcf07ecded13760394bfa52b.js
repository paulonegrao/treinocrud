...
var TalkingStick = (function(self) {
  ...
  self.handleDevices = function(devices) {
    ...
    devices = devices.map(function(device) {
      ...
      if (tsDevice.kind === 'audio' && tsDevice.label == '') {
        tsDevice.label = "microphone " + microphones++;
      } else if (tsDevice.kind === 'video' && tsDevice.label == '') {
        tsDevice.label = "camera " + cameras++;
      }
      return tsDevice;
    });
  ...
  self.addPartner = function(participant) {
    ...
    partnerVideo.attr('poster', "/assets/talking_stick/line-spinner-cc98937cb2c2eaa1d2ac92d9c5888e089ffb69a8bfca34332431e803f8fafe2c.svg"); // <video poster="talking_stick/line-spinner.svg"
...
(function() {
  $(function() {
    return $(document).on('change', '#lectures_select', function(evt) {
      return $.ajax('update_topics', {
        type: 'GET',
        dataType: 'script',
        data: {
        ...
        success: function(data, textStatus, jqXHR) {
          return console.log("Dynamic Topic select OK!");
        }
      });
    });
  });
...
(function() {
    ...
    function loadIFrame(loadCallback) {
        ...
        iframe.src = 'https://localhost:3001/getScreenId.html/'; // https://wwww.yourdomain.com/getScreenId.html
