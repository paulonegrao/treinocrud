...
CLIENT_SECRETS_FILE = "/Users/paulonegrao/codecore/railsdir/tam_for_dummies_app/app/views/events/client_secrets.json"
...
if __name__ == "__main__":
  argparser.add_argument("--broadcast-title", help="Broadcast title",
    default="tam4dummies broadcast")
  argparser.add_argument("--broadcast-description", help="Broadcast description",
    default="tam4dummies broadcast description")
  ...
  argparser.add_argument("--start-time", help="Scheduled start time",
    default='2016-02-28T00:00:00.000Z')
  argparser.add_argument("--end-time", help="Scheduled end time",
    default='2016-02-28T01:00:00.000Z')
  argparser.add_argument("--stream-title", help="Stream title",
    default="tam4dummies streams")
  argparser.add_argument("--stream-description", help="Stream description",
    default="tam4dummies streams description")
